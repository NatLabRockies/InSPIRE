...
def main():
    ...
    parser.add_argument('model_outs_dir', help='agrivolt-ground-irradiance model outputs directory')
    parser.add_argument('postprocess_dir', help='postprocessing outputs directory as generated by submit_postprocessing.slurm and postprocess.py')
    parser.add_argument('final_dir', help='final output path of combined model-outs and postprocessing')
